...
urlpatterns = [
    ...
    path('account/social-connect-guide/', views.social_connect_guide, name='social_connect_guide'),
    path('account/signup-soon/', views.signup_soon, name='signup_soon'),
    ...
    path('company/', views.company_intro, name='company_intro'),
    ...
    path('equipment/<int:pk>/attachment-site/', views.attachment_ad_site_redirect, name='attachment_ad_site_redirect'),
    ...
    path('info/api/videos/', views.excavator_info_videos_api, name='excavator_info_videos_api'),
    path('info/api/catalog/', views.excavator_info_catalog_api, name='excavator_info_catalog_api'),
